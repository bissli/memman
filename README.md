...
- **LLM reconciliation** — each fact classified as ADD/UPDATE/DELETE/NONE against existing memories; a byte-identical restatement skips the LLM and bumps the stored row's `corroboration_count` instead.
