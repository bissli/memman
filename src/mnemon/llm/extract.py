...
from mnemon.llm.client import LLMClient, parse_json_response
...
FACT_EXTRACTION_SYSTEM = (
    ...
    '- Category: preference=likes/dislikes, decision=chose X over Y, '
    'fact=objective info, insight=lesson learned, '
    'context=project/situation.\n'
    '- Importance: 2=minor, 3=normal working knowledge, '
    '4=important decision/preference, 5=critical architecture or '
    'core belief.\n'
